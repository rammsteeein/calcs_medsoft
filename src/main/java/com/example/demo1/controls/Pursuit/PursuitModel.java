...
public class PursuitModel {
    ...
    public void setMale(boolean isMale) { this.isMale.set(isMale); }
    ...
    public void calc() {
        try {
            ...
            PursuitResult calcResult = PursuitCalculator.calc(ageValue, isMale(), isHasAngina(), isHasHeartFailure());
