...
public class DLCNCalculator {
     ...
     */
        ...
        public static DLCNResult calc(
            ...
            String diagnosis;
            if (score >= 8) {
                diagnosis = "Достоверный диагноз FH";
            } else if (score >= 6) {
                diagnosis = "Вероятный диагноз FH";
            } else if (score >= 3) {
                diagnosis = "Возможный диагноз FH";
            } else {
                diagnosis = "FH маловероятна";
            }

            return new DLCNResult(score, diagnosis);
        }
    }