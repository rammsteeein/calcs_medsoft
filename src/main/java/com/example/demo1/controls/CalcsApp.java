...
import com.example.demo1.controls.APACHEII.APACHEIIControl;
import com.example.demo1.controls.APACHEII.APACHEIIModel;
...
import com.example.demo1.controls.CTSI.CTSIControl;
import com.example.demo1.controls.CTSI.CTSIModel;
...
import com.example.demo1.controls.Ranson.RansonControl;
import com.example.demo1.controls.Ranson.RansonModel;
...
public class CalcsApp extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        calculatorMap.put("SCORE2", () -> new Score2Control(new Score2Model()));
        ...
        calculatorMap.put("Шкала Ranson", () -> new RansonControl(new RansonModel()));
        calculatorMap.put("Шкала APACHE II", () -> new APACHEIIControl(new APACHEIIModel()));
        calculatorMap.put("Индекс тяжести КТ (Balthazar)", () -> new CTSIControl(new CTSIModel()));
