...
public class Score2Calculator {

    /**
     * Шкала SCORE2 (Systematic COronary Risk Evaluation 2)
     * для оценки 10-летнего риска фатальных и нефатальных сердечно-сосудистых событий
     * у пациентов в возрасте от 40 до 69 лет включительно (базовая, "не пожилая" версия шкалы).
     ...
     *    - С увеличением возраста риск возрастает
     * 2. Пол:
     ...
     * - Значения определяются по возрасту, полу, статусу курения,
     ...
     * Особенности:
     * - Применяется для возрастной группы младше 70 лет (для 70+ используется SCORE2-OP)
     * - Используется для первичной профилактики сердечно-сосудистых заболеваний
     */

    public static Score2Result calc(
            boolean absolute,
            int age,
            String gender,
            boolean smoking,
