...
public class RCRICalculator {
    ...
    public static RCRIResult calc(
        ...
        switch (score) {
            case 0:
                interpretation = "Риск большого кардиального события: 3,9% (2,8–5,4%)";
                break;
            case 1:
                interpretation = "Риск большого кардиального события: 6,0% (4,9–7,4%)";
                break;
            case 2:
                interpretation = "Риск большого кардиального события: 10,1% (8,1–12,6%)";
                break;
            default:
                interpretation = "Риск большого кардиального события: 15% (11,1–20,0%)";
                break;
        }
